...
// Legends
$GLOBALS['TL_LANG']['tl_content']['personal_legend'] = 'Informationen zur Person';

// Fields
$GLOBALS['TL_LANG']['tl_content']['ceTeamMemberFirstname'] = ['Vorname', 'Geben Sie den Vornamen ein.'];
